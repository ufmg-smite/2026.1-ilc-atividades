...
def grading_prompt(question, criteria, answer):
    ...
    parts = [
        ...
        "  avalie a resposta como se estivesse transcrita certa — dê o benefício da dúvida ao",
        "  aluno. É muito mais provável que a máquina tenha lido errado do que o aluno ter",
        "  escrito um símbolo absurdo.",
        "  Sinais típicos de erro de leitura: um símbolo que quebra uma cadeia coerente; uma",
        "  variável que troca de nome no meio da linha (x lido como n); ∧ e ∨, → e ←, p e q",
        "  invertidos; parênteses perdidos.",
        "  LIMITE: isto vale para trechos ILEGÍVEIS ou implausíveis, não para respostas",
        "  coerentes e simplesmente erradas. Se a resposta faz sentido do começo ao fim e está",
        "  errada, é erro do ALUNO — não a conserte.",
        "  Sempre que aplicar essa correção, comece a justificativa com \"[transcrição]\" e diga",
        "  o que assumiu, para o corretor conferir o manuscrito.",
